...
def createArticle(request: ArticleBase, db: Session = Depends(getDB)):
...
def readOneArticle(id: int, db: Session = Depends(getDB)):
...
def updateArticle(id: int, request: ArticleBase, db: Session = Depends(getDB)):
...
def deleteArticle(id: int, db: Session = Depends(getDB)):
